...
public class DiffMatch
{
	 ...
	 */
	public LinkedList<Diff> diffTexts(String text1, String text2)
	{
		return diffTexts(text1, text2, true);
	}
	 ...
	 * @return Linked List of Diff objects.
	 */
	public LinkedList<Diff> diffTexts(String text1, String text2, boolean checklines)
	{
	...
	public LinkedList<Patch> patch_make(String text1, String text2)
	{
		...
		LinkedList<Diff> diffs = diffTexts(text1, text2, true);
		if (diffs.size() > 2)
		{
			diff_cleanupSemantic(diffs);
		...
		for (Patch aPatch : patches)
		{
			...
			} else
			{
				...
				} else
				{
					...
					// indices.
					LinkedList<Diff> diffs = diffTexts(text1, text2, false);
					if (text1.length() > this.Match_MaxBits
							...
							if (aDiff.operation != Operation.EQUAL)
							{
								...
								} else if (aDiff.operation == Operation.DELETE)
								{
									...
									text = text.substring(0, start_loc + index2)
											+ text.substring(start_loc + diff_xIndex(diffs, index1 + aDiff.text.length()));
								}
							}
							if (aDiff.operation != Operation.DELETE)
							{
